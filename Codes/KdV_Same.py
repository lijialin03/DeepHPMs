...
class DeepHPM:
    ...
    def sol_init(self, x0, u0, tb, X_f, layers):
        ...
        self.u_lb_pred, self.u_x_lb_pred, self.u_xx_lb_pred = self.sol_net_u(
            self.t_lb_tf, self.x_lb_tf
        )
        self.u_ub_pred, self.u_x_ub_pred, self.u_xx_ub_pred = self.sol_net_u(
            self.t_ub_tf, self.x_ub_tf
        )
...
if __name__ == "__main__":
    ...
    savefig("../fig_test/KdV_Extrapolate")
