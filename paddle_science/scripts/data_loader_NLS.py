...
class DataLoader(object):
    ...
    def load_sol(self):
        ...
        self.Exact_u_sol = data_sol["Exact_u_ori"]
        self.Exact_v_sol = data_sol["Exact_u_ori"]
        self.Exact_uv_sol = data_sol["Exact_uv_ori"]
        ...
        self.v_sol_star = data_sol["v_ori"]

        self.x0_train = data_sol["x0"]
        self.u0_train = data_sol["u0"]
        self.v0_train = data_sol["v0"]
