...
if __name__ == "__main__":
    ...
    # Adam
    # optimizer_idn = ppsci.optimizer.Adam(lr_scheduler)([model_idn])
    # optimizer_pde = ppsci.optimizer.Adam(lr_scheduler)([model_pde])
    # optimizer_sol = ppsci.optimizer.Adam(lr_scheduler)([model_sol])
