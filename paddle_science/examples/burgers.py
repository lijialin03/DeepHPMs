...
from ppsci.loss import MSELoss, PeriodicMSELoss
...
class LossPde(MSELoss):
    ...
    def forward(self, output_dict, label_dict, weight_dict=None):
        ...
        losses = super().forward(out_dict, label_dict, None)
        return losses


class LossBoundary(PeriodicMSELoss):
    def __init__(self, reduction: str = "mean"):
        super().__init__(reduction)
    ...
    def forward(self, output_dict, label_dict, weight_dict=None):
        ...
        # out_dict = {"ub": u_lb, "du_x_b": du_x_lb}
        # label_dict = {"ub": u_ub, "du_x_b": du_x_ub}
        ...
        label_dict = {"u_sol": "", "du_x_sol": ""}
        # out_dict = {"ub_sol": u_b, "du_x_sol": du_x}
        losses = super().forward(output_dict, label_dict, None)
        return losses
...
if __name__ == "__main__":
    ...
    ITERS_PER_EPOCH = 1
    LEARNING_RATE = 1e-3
    DATASET_PATH = "../dataset_gen/burgers_sine.mat"
    DATASET_PATH_SOL = "../dataset_gen/burgers.mat"
    OUTPUT_DIR = "../outs_2/"
    ...
    train_dataloader_cfg_sol_bc = {
        "dataset": {
            ...
            "input_keys": ("t", "x"),
            "label_keys": ("du_x_sol",),
            "alias_dict": {"t": "tb", "x": "xb", "du_x_sol": "xb"},
        },
    }
