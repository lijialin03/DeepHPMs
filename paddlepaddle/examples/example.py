...
sys.path.append("../../")
from paddlepaddle.model.net import Network
from paddlepaddle.model.deephpm import DeepHPM

from paddlepaddle.scripts.data_loader import DataLoader as DataLoader_ori
...
class Example(object):
    ...
    def run(
        ...
        file_idn = "../../paddle_science/dataset_gen/KdV_sine.mat"
        file_sol = "../../paddle_science/dataset_gen/KdV_sine.mat"
        # Load Data
        data = DataLoader()
        # data = DataLoader_ori()
        ...
        if "debug_gen_pde" in mode:
            ...
            u_pred, f_pred = model.predict(data.t_sol_star, data.x_sol_star, "pde")
            plot = Plotting(
                figname + "_debug_idn",
                data.lb_sol,
                data.ub_sol,
            ...
            plot.draw_n_save(data.Exact_sol, f_pred)
            plot.draw_t_2d(data.Exact_sol, f_pred)
